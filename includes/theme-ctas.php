    ...
    if (sizeof($field_names) == 1) {
      ...
      foreach ($field_names as $field_name) {
        ...
        if ($button_text != '') {
          ...
          $cta_appearance = $field_name['cta_appearance'];
          $cta_html .= '<a href="' . $cta_url . '" target="' . $target . '" class="' . $cta_url_modal_class . ' absl" data-modal-open-id="' . $data_modal_open_id . '" title="' . $cta_title . ' ' . $button_text . '" aria-label="' . $cta_title . ' ' . $button_text . '"></a>';
        }
      }
      echo $cta_html;
    }
