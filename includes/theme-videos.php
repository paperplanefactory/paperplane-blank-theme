					...
					<div class="expanding-block">
						<div class="expander-top">
							<button id="expand-button-<?php echo $videos_count; ?>" class="expander exp-open" aria-expanded="false"
								...
								aria-label="<?php echo __('Leggi la trascrizione del video', 'paperPlane-blankTheme').': '.__('questo bottone permette di accedere ad un approfondimento', 'paperPlane-blankTheme'); ?>"><span
						...
						<div id="expand-content-<?php echo $videos_count; ?>" class="expandable-content">
							<div class="inner">
								<div class="content-styled last-child-no-margin">
									...
									<button id="expand-close-button-<?php echo $videos_count; ?>" class="expander-closer"
										data-expand-id="<?php echo $videos_count; ?>"
										title="<?php echo __('Chiudi', 'paperPlane-blankTheme'); ?>"
										aria-label="<?php echo __('Chiudi', 'paperPlane-blankTheme'); ?>">
