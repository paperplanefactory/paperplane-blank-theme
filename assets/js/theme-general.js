...
jQuery(document).on('click', '.animation-play-pause-js:not(.initialized)', function (e) {
  ...
  jQuery('.header-menu .mega-menu-js-trigger, .header-menu .sub-menu-btn, .header-menu .simple-link').on('focusin', function () {
    ...
    */
    ...
    jQuery('.remove-underline-js, .cta-holder a').mouseenter(function () {
      jQuery(this).parent().parent().addClass('no-underline');
    });
    jQuery('.remove-underline-js, .cta-holder a').mouseleave(function () {
      jQuery(this).parent().parent().removeClass('no-underline');
    });