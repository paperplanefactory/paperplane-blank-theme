...
AOS.init({duration:900,once:!1,mirror:!0,offset:180});function initInfiniteScroll(){$(".grid-infinite")[0]&&($(".grid-infinite").infiniteScroll({path:".nav-next a",append:".grid-item-infinite",status:"#infscr-loading",prefill:!0,history:"push",historyTitle:!0}),$(".grid-infinite").on("append.infiniteScroll",function(a,c,b,d){paperPlaneLazyLoad.update();AOS.refresh()}),window.setInterval(function(){$(".infinite-scroll-last").is(":visible")&&$("#infscr-loading").fadeOut(300)},3E3))}initInfiniteScroll();
...
$(".slide-double").slick({lazyLoad:"ondemand",dots:!1,focusOnSelect:!0,draggable:!0,infinite:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:2,slidesToScroll:1,nextArrow:'<div class="slick-next"><div class="slide-button-shaper"><i class="fas fa-arrow-right" aria-label="next"></i></div></div>',prevArrow:'<div class="slick-prev"><div class="slide-button-shaper"><i class="fas fa-arrow-left" aria-label="previous"></i></div></div>',responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});
...
function hidePreload(){$(".preload-container").addClass("hidden-preload")};
