...
$(".slide-double").slick({dots:!1,focusOnSelect:!0,draggable:!0,infinite:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:2,slidesToScroll:1,nextArrow:'<div class="slick-next"><i class="fas fa-long-arrow-alt-right" aria-label="next"></i></div>',prevArrow:'<div class="slick-prev"><i class="fas fa-long-arrow-alt-left" aria-label="previous"></i></div>'});$(document).on("keydown",function(a){37==a.keyCode&&$(".single-item").slick("slickPrev");39==a.keyCode&&$(".single-item").slick("slickNext")});$(".ham-activator").click(function(a){hamburgerMenu()});
