...
a.preventDefault()});jQuery(".overlay-menu-mobile-js > .menu-item-has-children").click(function(a){jQuery(this).find(".sub-menu").slideToggle(150);a.preventDefault()});jQuery(window).scroll(function(){numbers_counter()});function hidePreload(){jQuery(".preload-container").addClass("hidden-preload")};
