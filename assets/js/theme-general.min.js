...
a.preventDefault()});jQuery(".paperplane-modal")[0]&&(jQuery(".modal-close-js").click(function(a){var b=jQuery(this).data("modal-close-id");jQuery(b).addClass("hidden");jQuery("html, body").css({overflow:"visible"});a.preventDefault()}),jQuery(".modal-open-js").click(function(a){var b=jQuery(this).data("modal-open-id");jQuery(b).removeClass("hidden");jQuery("html, body").css({overflow:"hidden"});a.preventDefault()}));
...
jQuery(".hide-me").click(function(a){jQuery(this).parent().parent().toggleClass("hidden-label");a.preventDefault()});function hidePreload(){jQuery(".preload-container").addClass("hidden-preload")};
