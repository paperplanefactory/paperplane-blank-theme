...
jQuery(this).removeClass("blurred-counter");console.log(a)}})})}}numbers_counter();
...
a.preventDefault()});function clear_overlay_scroll(){var a=jQuery(window).width();jQuery("#head-overlay").hasClass("hidden")||(1023<a?jQuery("html, body").css({overflow:"visible"}):jQuery("html, body").css({overflow:"hidden"}))}jQuery(window).scroll(function(){numbers_counter()});var vh=.01*window.innerHeight;document.documentElement.style.setProperty("--vh",vh+"px");
window.addEventListener("resize",function(){var a=.01*window.innerHeight;console.log(a);document.documentElement.style.setProperty("--vh",a+"px")});function hidePreload(){jQuery(".preload-container").addClass("hidden-preload")};
