...
AOS.init({duration:900,once:!1,mirror:!0});function initInfiniteScroll(){$(".grid-infinite")[0]&&($(".grid-infinite").infiniteScroll({path:".nav-next a",append:".grid-item-infinite",status:"#infscr-loading",prefill:!0,history:"push",historyTitle:!0}),$(".grid-infinite").on("append.infiniteScroll",function(a,c,b,d){paperPlaneLazyLoad.update();AOS.refresh()}),window.setInterval(function(){$(".infinite-scroll-last").is(":visible")&&$("#infscr-loading").fadeOut(300)},3E3))}initInfiniteScroll();
...
var lastScrollTop=0;function scrollDirectionMenu(){var a=$(this).scrollTop();a>lastScrollTop&&100<a?($("#header").addClass("hidden"),$(".mega-menu-js").addClass("hidden")):$("#header").removeClass("hidden");lastScrollTop=a}$(window).scroll(function(a){scrollDirectionMenu()});$(".mega-menu-js").mouseleave(function(){$(this).addClass("hidden")});function goBelowTheFold(){$("html, body").animate({scrollTop:$(".below-the-fold").offset().top-100},500)}$("#intro-scroll-js").click(function(){goBelowTheFold()});
...
$(".slide-double").slick({lazyLoad:"ondemand",dots:!1,focusOnSelect:!0,draggable:!0,infinite:!0,accessibility:!0,adaptiveHeight:!1,slidesToShow:2,slidesToScroll:1,nextArrow:'<div class="slick-next"><div class="slide-button-shaper"><i class="fas fa-long-arrow-alt-right" aria-label="next"></i></div></div>',prevArrow:'<div class="slick-prev"><div class="slide-button-shaper"><i class="fas fa-long-arrow-alt-left" aria-label="previous"></i></div></div>'});
$(document).on("keydown",function(a){37==a.keyCode&&$(".single-item").slick("slickPrev");39==a.keyCode&&$(".single-item").slick("slickNext")});$(".count");function activateCounter(){$(".count").each(function(){$(this).prop("Counter",0).animate({Counter:$(this).attr("data-bar-number")},{duration:2E3,step:function(a){$(this).text(Math.ceil(a));$(this).hasClass("percent-justnumber")&&$(this).text($(this).text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,"))}})})}
if(window.IntersectionObserver){var observer=new IntersectionObserver(function(a,c){a.forEach(function(a){a.isIntersecting&&(console.log(a),a.target.src=a.target.dataset.src,activateCounter(),c.unobserve(a.target))})},{rootMargin:"0px 0px -200px 0px"});document.querySelectorAll(".count").forEach(function(a){observer.observe(a)})}else document.querySelector("#warning").style.display="block";$(".ham-activator").click(function(a){hamburgerMenu()});
...
function hidePreload(){$(".preload-container").addClass("hidden-preload")}window.addEventListener("load",hidePreload);
