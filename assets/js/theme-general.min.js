...
jQuery(".paperplane-modal")[0]&&(jQuery(".modal-close-js").click(function(a){var b=jQuery(this).data("modal-close-id");jQuery(b).addClass("hidden");b=jQuery(".video-frame > iframe").attr("src");jQuery(".video-frame > iframe").attr("src","");jQuery(".video-frame > iframe").attr("src",b);jQuery("html, body").css({overflow:"visible"});a.preventDefault()}),jQuery(".modal-open-js").click(function(a){var b=jQuery(this).data("modal-open-id");jQuery(b).removeClass("hidden");jQuery("html, body").css({overflow:"hidden"});
