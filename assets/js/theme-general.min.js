...
jQuery(".slide-double-js, .slide-single-js").on("init reInit afterChange",function(a,c,b,d){AOS.refresh()});jQuery(".slide-double-js").slick({lazyLoad:"progressive",dots:!0,focusOnSelect:!0,draggable:!0,infinite:!1,accessibility:!0,adaptiveHeight:!1,slidesToShow:2,slidesToScroll:1,arrows:!0,nextArrow:'<div class="slick-next">\u2192</div>',prevArrow:'<div class="slick-prev">\u2190</div>',responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});
jQuery(document).on("keydown",function(a){37==a.keyCode&&jQuery(".slide-single-js").slick("slickPrev");39==a.keyCode&&jQuery(".slide-single-js").slick("slickNext")});
jQuery(".slide-single-js").slick({lazyLoad:"progressive",dots:!0,focusOnSelect:!0,draggable:!0,infinite:!1,accessibility:!0,adaptiveHeight:!1,slidesToShow:1,slidesToScroll:1,arrows:!0,nextArrow:'<div class="slick-next">\u2192</div>',prevArrow:'<div class="slick-prev">\u2190</div>',responsive:[{breakpoint:1024,settings:{slidesToShow:1,slidesToScroll:1}}]});jQuery(".count");
function activateCounter(){jQuery(".count").each(function(){jQuery(this).prop("Counter",0).animate({Counter:jQuery(this).attr("data-bar-number")},{duration:2E3,step:function(a){jQuery(this).text(Math.ceil(a));jQuery(this).hasClass("percent-justnumber")&&jQuery(this).text(jQuery(this).text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,"))}})})}
if(window.IntersectionObserver){var observer=new IntersectionObserver(function(a,c){a.forEach(function(a){a.isIntersecting&&(console.log(a),a.target.src=a.target.dataset.src,activateCounter(),c.unobserve(a.target))})},{rootMargin:"0px 0px -200px 0px"});document.querySelectorAll(".count").forEach(function(a){observer.observe(a)})}else document.querySelector("#warning").style.display="block";
...
a.preventDefault()});jQuery(".overlay-menu-mobile-js > .menu-item-has-children").click(function(a){jQuery(this).find(".sub-menu").slideToggle(150);a.preventDefault()});function hidePreload(){jQuery(".preload-container").addClass("hidden-preload")};
