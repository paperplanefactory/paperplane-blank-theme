...
$(document).on("keydown",function(a){37==a.keyCode&&$(".single-item").slick("slickPrev");39==a.keyCode&&$(".single-item").slick("slickNext")});$(".ham-activator").click(function(a){hamburgerMenu()});
