...
<div class="wrapper module-fullscreen-image">
  <?php if ( $module_fullscreen_image_image != '' ) : ?>
    <div class="module-box-fullscreen fullscreen-cta <?php the_sub_field( 'module_fullscreen_text_align' ); ?> lazy coverize <?php echo $blended_class; ?> <?php the_sub_field( 'module_fullscreen_image_color_scheme' ); ?>" data-bg="<?php echo $module_fullscreen_image_image_URL; ?>" data-aos="fade">
  <?php else : ?>
