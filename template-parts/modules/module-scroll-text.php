		...
		<div class="scrolling-txt-wrapper">
			<div class="scrolling-txt-container">
				<div id="module-scroll-text-<?php echo $module_count; ?>"
					class="horizontal-scrolling-items horizontal-scrolling-items-<?php echo $module_count; ?> fluid-typo animate">
			...
			<button id="module-scroll-text-<?php echo $module_count; ?>-control"
				class="play-pause-animation animation-stop-js pause"
				data-video-stop="module-scroll-text-<?php echo $module_count; ?>"
				aria-label="<?php _e( 'Ferma animazione', 'paperPlane-blankTheme' ); ?>" aria-pressed="true"
