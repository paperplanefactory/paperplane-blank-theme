...
?>
<div
  class="paperplane-modal paperplane-modal-js-<?php echo get_the_ID(); ?> hidden <?php the_field('colore_di_sfondo_modal'); ?>">
  <div class="modal-close-area modal-close-js" data-modal-close-id=".paperplane-modal-js-<?php echo get_the_ID(); ?>">
  </div>
  <div class="modal-box offerta-overlay-box-js" style="max-width: <?php echo $content_fields['modal_max_width']; ?>px">
    ...
    <div class="modal-close-button modal-close-js"
      data-modal-close-id=".paperplane-modal-js-<?php echo get_the_ID(); ?>">
      <svg>
