<?php
global $acf_options_parameter, ${$options_fields_multilang . $acf_options_parameter}, $mega_menu_wrapper;
$mega_menu_counter = 0;
var_dump($mega_menu_counter);
if (${$options_fields_multilang . $acf_options_parameter}['mega_menu_repeater']):
  foreach (${$options_fields_multilang . $acf_options_parameter}['mega_menu_repeater'] as $mega_menu_data):
    $mega_menu_counter++;
    ?>
    <nav
      class="mega-menu mega-menu-js mega-menu-js-<?php echo $mega_menu_counter; ?>-<?php echo $acf_options_parameter; ?>-target hidden">
          ...
          <div class="flex-hold flex-hold-3 margins-wide">
            ...
            <div class="flex-hold-child">
              ...
              $image_data = array(
                ...
                'image_value' => 'mega_menu_repeater_image',
            ...
            <div class="flex-hold-child">
              <div class="last-child-no-margin">
                <p>
                  <?php echo $mega_menu_data['mega_menu_repeater_additional_info']; ?>
                </p>
              </div>
              <?php paperplane_theme_cta_advanced($mega_menu_data['paperplane_theme_cta_mega_menu']); ?>
            </div>
          </div>
        </div>
      </div>
