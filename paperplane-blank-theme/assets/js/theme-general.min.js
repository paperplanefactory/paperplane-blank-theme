...
$(document).on("keydown",function(a){37==a.keyCode&&$(".single-item").slick("slickPrev");39==a.keyCode&&$(".single-item").slick("slickNext")});$(".slider-for").slick({slidesToShow:1,slidesToScroll:1,infinite:!0,arrows:!1,lazyLoad:"ondemand",swipeToSlide:!0,vertical:!0});
$(".slider-nav").slick({slidesToShow:5,slidesToScroll:1,infinite:!0,asNavFor:".slider-for",swipeToSlide:!0,dots:!1,centerMode:!0,arrows:!0,focusOnSelect:!0,lazyLoad:"ondemand",nextArrow:'<div class="slick-next"><i class="fas fa-long-arrow-alt-right" aria-label="next"></i></div>',prevArrow:'<div class="slick-prev"><i class="fas fa-long-arrow-alt-left" aria-label="previous"></i></div>'});$(".ham-activator").click(function(a){hamburgerMenu()});
...
function init(){new SmoothScroll(document,150,10)}init();
