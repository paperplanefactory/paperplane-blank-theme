...
if ( !is_admin() ) {
	function add_font_awesome_5_cdn_attributes( $html, $handle ) {
		if ( 'theme-font-awesome' === $handle ) {
			return str_replace( "media='all'", "media='all' integrity='sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr' crossorigin='anonymous' async='async'", $html );
		}
		return $html;
	}
	...
	function theme_css() {
		...
		wp_enqueue_style( 'theme-font-awesome', 'https://use.fontawesome.com/releases/v5.7.2/css/all.css#asyncload', array(), null );
